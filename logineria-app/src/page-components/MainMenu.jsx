...
import { componentOnClick, wireModeOnClick } from "../logic/menuFunctions.js";
        ...
        <>
            <aside  className="menu-container">
                    ...
                    <div className="menu-buttons">
                        <button className="menu-button">New Canvas</button>
                        <button className="menu-button">Import</button>
